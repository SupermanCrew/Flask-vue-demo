  ...
  <el-card shadow="never" style="margin-top: 10px;">
    ...
    <el-table :data="tableData" stripe>
      ...
      <el-table-column label="图书图片">
        ...
        <img :src="'http://127.0.0.1:5000/upimg/' + scope.row.img_url" width="100" height="100">
  ...
  <sDrawer v-model="visible" :title="form.id ? '编辑学院' : '添加学院'" size="35%" :close-on-click-modal="false">
    ...
    <el-form-item label="图书图片:">
        <div v-if="form.id">
          <el-upload
            class="upload-demo"
            action="http://127.0.0.1:5000/img_upload/"
            :data={data:form.id}
    ...
    <el-form :model="form" label-width="80px" ref="ruleFormRef">
      <el-form-item label="出版社:">
        <el-select v-model="form.publishs_id" clearable placeholder="请选择">
                <el-option
